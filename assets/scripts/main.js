...
function initFormHandler() {
	...
	if (recipeObject.rating) recipeObject.rating = Number(recipeObject.rating);
	if (recipeObject.numRatings) recipeObject.numRatings = Number(recipeObject.numRatings);
